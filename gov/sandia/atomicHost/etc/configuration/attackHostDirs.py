from gov.sandia.atomicHost.filesystem.directories import Folder
import sys
import os
import os.path
import glob
...
class Config:
    ...
    def __init__(self):
        ...
        self.discoveryCategoryScriptDir = os.path.normpath(os.path.join(self.absInstallationDir,"gov/sandia/atomicHost/ah/discovery"))
